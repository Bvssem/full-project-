...
public class CartController {
    ...
    @PutMapping("/update")
    public Cart updateCart(@RequestParam Long cartId, @RequestParam Long courseId, @RequestParam int quantity) {
        return cartService.updateCart(cartId, courseId, quantity);
    }
}