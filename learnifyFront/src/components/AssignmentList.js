...
import './AssignmentList.css'; // Ensure you have this CSS file for custom styles
      ...
      <ul className="assignment-list">
        {assignments.map(assignment => (
          <li key={assignment.id} className="assignment-item">
            <Link to={`/assignments/${assignment.id}`} className="assignment-link">{assignment.title}</Link>
          </li>
        ))}
      </ul>
    </div>
